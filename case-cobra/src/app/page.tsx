    ...
    <div className="bg-slate-50">
      <section>
        ...
        lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:p-32 lg:pb-52">
              ...
              <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                ...
                <div className="flex flex-col justify-between items-center sm:items-start">
                  <div className="flex gap-0.5">
                    <Star className="text-green-600 fill-green-600 w-4 h-4"></Star>
                    <Star className="text-green-600 fill-green-600 w-4 h-4"></Star>
                    <Star className="text-green-600 fill-green-600 w-4 h-4"></Star>
                    <Star className="text-green-600 fill-green-600 w-4 h-4"></Star>
                    <Star className="text-green-600 fill-green-600 w-4 h-4"></Star>
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32
          lg:mx-0 lg:mt-20 h-fit">
            <div className="relative md:max-w-xl">
              <img className="absolute w-40 lg:w-52 left-56 -top-20 select-none hidden 
              sm:block lg:hidden xl:block" src="/your-image.png" alt="your image" />
              <img className="absolute w-20 -left-6 -bottom-6 select-none" src="/line.png" alt="image line" />
              <Phone dark={false} className="w-64" imgSrc="/testimonials/1.webp"></Phone>
            </div>
          </div>
        </MaxWidth>
      </section>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            <h2 className='order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900'>
              ...
              <span className='relative px-2'>
                customers{' '}
                <Icons.underline className='hidden md:block pointer-events-none absolute inset-x-0 w-fit -bottom-6 text-green-500' />
              </span>{' '}
              say
            </h2>
            <img className="w-24 order-0 lg:order-2" src="/snake-2.png" alt="snake image" />
          </div>
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0
          lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              <div className="flex gap-0.5 mb-2">
                <Star className="h-5 w-5 fill-green-600 text-green-600"></Star>
                <Star className="h-5 w-5 fill-green-600 text-green-600"></Star>
                <Star className="h-5 w-5 fill-green-600 text-green-600"></Star>
                <Star className="h-5 w-5 fill-green-600 text-green-600"></Star>
                <Star className="h-5 w-5 fill-green-600 text-green-600"></Star>
        ...
        <MaxWidth className='py-24'>
          ...
          <div className='mx-auto max-w-6xl px-6 lg:px-8'>
            <div className='relative flex flex-col items-center md:grid grid-cols-2 gap-40'>
              ...
              <Phone dark={false} className='w-60' imgSrc='/horse_phone.jpg' />
            </div>
          </div>
